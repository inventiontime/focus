...
List<String> alarmPaths = [
  'assets/audio/Daybreak.mp3',
  'assets/audio/EarlyRiser.mp3',
  'assets/audio/SlowMorning.mp3'
];
...
ThemeData theme = ThemeData(
    ...
    textTheme: TextTheme(
      headline1: TextStyle(
          fontSize: 35.0, fontWeight: FontWeight.bold, color: foregroundColor),
      headline2: TextStyle(
          fontSize: 40.0, fontWeight: FontWeight.bold, color: foregroundColor),
      headline3: TextStyle(
          fontSize: 25.0, fontWeight: FontWeight.bold, color: foregroundColor),
