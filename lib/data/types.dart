...
@HiveType(typeId : 3)
class Session {
  Session({this.time, this.day, this.hour, this.details, this.tagId, this.productivity});

  @HiveField(0) int time; // how long session was
  @HiveField(1) int day; // day on which session was completed
  @HiveField(2) int hour;
  @HiveField(3) bool details = false; // set to true when tagId/productivity is set
  @HiveField(4) int tagId = -1;
  @HiveField(5) int productivity = -1;
}
