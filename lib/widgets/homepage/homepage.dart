...
import 'package:focus/widgets/homepage/help.dart';
          ...
          children: [
            ...
            Container(
              ...
              child: Column(
                  ...
                  children: [
                    Text(type.toString().substring(13).capitalize(),
                        style: Theme.of(context).textTheme.headline1),
                    SizedBox(height: 40),
                    if (type == HomePageType.dashboard)
                      Dashboard().expanded()
                    else if (type == HomePageType.timer)
                      Timer().expanded()
                    else if (type == HomePageType.settings)
                      Settings().expanded()
                    else if (type == HomePageType.help)
                      Help().expanded(),
                  ]).padding(40),
